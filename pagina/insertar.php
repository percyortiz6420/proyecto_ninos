...
$caracteres_buenos = array("& lt;", "& gt;", "& quot;", "& #x27;", "& #x2F;", "& #060;", "& #062;", "& #039;", "& #047;");
    ...
    $email_encargado=str_replace($caracteres_malos, $caracteres_buenos, $email_encargado);
...
if (in_array($_FILES['imagen']['type'], $permitidos))
{
    ...
    if(move_uploaded_file($ruta,$destino)){
        ...
        $consulta = "INSERT INTO encargado (nombre, apellido, telefono1,email, nombre_nino, apellido_nino, edad, atención_especial,ruta) VALUES ('$Nombre_encargado', '$Apellido_encargado', '$Telefono_encargado','$email_encargado', '$Nombre_nino', '$Apellido_nino', '$edad_nino', '$Descripcion','$destino')";
